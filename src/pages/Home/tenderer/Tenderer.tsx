  ...
  return (
    <section className="tenderer-info">
      <div className="container">
        ...
        <Row
          gutter={{xs: 8, sm: 16, md: 24, lg: 32}}
          className="row-tenderer-news"
        >
          <Col span={14} className="col-tenderer-news">
            <Space direction="vertical" size="middle">
              <Card
                className="tenderer-news"
                hoverable
                cover={
                  <img
                    alt="example"
          ...
          <Col span={10} className="document-guide">
            <div className="title-notice">
              <Divider type="vertical" /> Văn bản hướng dẫn
            </div>
            <Button type="text" className="notice-button">
              <div>
                <img
                  src={require("assets/images/icon/word.png")}
                  alt="icon-document"
                />
            ...
            <Button type="text" className="notice-button">
              <div>
                <img
                  src={require("assets/images/icon/ppt.png")}
                  alt="icon-document"
                />
                Thông báo thay đổi nhân sự
              </div>
              <DownloadOutlined color="#c83b3c" />
            </Button>
            <Button type="text" className="notice-button">
              <div>
                <img
