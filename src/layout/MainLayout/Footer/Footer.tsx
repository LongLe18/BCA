...
import { Layout, Dropdown, MenuProps, theme, Space, Menu, Input, Button } from "antd";
import { CaretDownOutlined, YoutubeFilled, FacebookFilled, InstagramFilled, LinkedinFilled } from '@ant-design/icons';
    ...
    <Footer style={footerStyle} id="footer">
      <div className="container d-flex align-items-center justify-content-center flex-column">
        ...
        <div className="container d-flex align-items-center justify-content-center" style={{marginTop: 50}}>
          <Space>
            <a href="/#"><YoutubeFilled style={{fontSize: '24px'}}/></a>
            <a href="/#"><FacebookFilled style={{fontSize: '24px'}}/></a>
            <a href="/#"><LinkedinFilled style={{fontSize: '24px'}}/></a>
            <a href="/#"><InstagramFilled style={{fontSize: '24px'}}/></a>
          </Space>
        </div>
      </div>
    </Footer>
